	...
	)
{
	...
	if(Method == MIX_MODE)	//normal Tx power tracking
	{
		...
		PHYDM_DBG(dm, ODM_COMP_TX_PWR_TRACK,  ("=========================== [Path-%d] TXBB Offset============================\n", RFPath));
		PHYDM_DBG(dm, ODM_COMP_TX_PWR_TRACK,  ("absolute_ofdm_swing_idx[RFPath](%d) = absolute_ofdm_swing_idx[RFPath](%d) + kfree_offset[RFPath](%d), RFPath=%d\n", cali_info->absolute_ofdm_swing_idx[RFPath], cali_info->absolute_ofdm_swing_idx[RFPath], cali_info->kfree_offset[RFPath], RFPath));
	...
	if(Final_RF_Index > UpperBound)		//Upper bound = 10dB, if more htan upper bound, then move to bb swing max = +2dB
	{
		...
		PHYDM_DBG(dm, ODM_COMP_TX_PWR_TRACK,  ("Final_OFDM_Swing_Index(%d) = default_ofdm_index(%d) + (absolute_ofdm_swing_idx[RFPath](%d) - (UpperBound(%d) << 1)), RFPath=%d\n", Final_OFDM_Swing_Index, cali_info->default_ofdm_index, cali_info->absolute_ofdm_swing_idx[RFPath], UpperBound, RFPath));
		
		if (Final_OFDM_Swing_Index > TxScalingUpperBound) {	/* bb swing upper bound = +2dB */
			Final_OFDM_Swing_Index = TxScalingUpperBound;
			PHYDM_DBG(dm, ODM_COMP_TX_PWR_TRACK,  ("Final_OFDM_Swing_Index(%d) > TxScalingUpperBound(%d)   Final_OFDM_Swing_Index = TxScalingUpperBound\n", Final_OFDM_Swing_Index, TxScalingUpperBound));
	...
	else if(Final_RF_Index < LowerBound)	// lower bound = -5dB
	{
		...
		PHYDM_DBG(dm, ODM_COMP_TX_PWR_TRACK,  ("Final_OFDM_Swing_Index(%d) = default_ofdm_index(%d) - ((LowerBound(%d)<<1) - absolute_ofdm_swing_idx[RFPath](%d)), RFPath=%d\n", Final_OFDM_Swing_Index, cali_info->default_ofdm_index, LowerBound, cali_info->absolute_ofdm_swing_idx[RFPath], RFPath));

		if (Final_OFDM_Swing_Index < TxScalingLowerBound) {	/* BB swing lower bound = -10dB */
			Final_OFDM_Swing_Index = TxScalingLowerBound;
			PHYDM_DBG(dm, ODM_COMP_TX_PWR_TRACK,  ("Final_OFDM_Swing_Index(%d) > TxScalingLowerBound(%d)   Final_OFDM_Swing_Index = TxScalingLowerBound\n", Final_OFDM_Swing_Index, TxScalingLowerBound));
			PHYDM_DBG(dm, ODM_COMP_TX_PWR_TRACK,  ("===========================================================================\n"));
		}
		return Final_OFDM_Swing_Index;
	}
	else		// normal case
	{
		...
		PHYDM_DBG(dm, ODM_COMP_TX_PWR_TRACK,  ("Final_OFDM_Swing_Index(%d) = default_ofdm_index(%d) + (absolute_ofdm_swing_idx[RFPath])//2(%d), RFPath=%d\n", Final_OFDM_Swing_Index, cali_info->default_ofdm_index, (cali_info->absolute_ofdm_swing_idx[RFPath])%2, RFPath));
		PHYDM_DBG(dm, ODM_COMP_TX_PWR_TRACK,  ("===========================================================================\n"));
	...
	)
{
	struct dm_struct	*		dm = (struct dm_struct	*)pDM_VOID;
		...
		if (Method == MIX_MODE)			
		{
			PHYDM_DBG(dm, ODM_COMP_TX_PWR_TRACK,  ("cali_info->default_ofdm_index=%d, cali_info->absolute_ofdm_swing_idx[RFPath]=%d, RF_Path = %d\n",
		...
		{
			PHYDM_DBG(dm, ODM_COMP_TX_PWR_TRACK,  ("=========================== [Path-%d] BBSWING Offset============================\n", RFPath));
	...
	)
{
	...
	PHYDM_DBG(dm, ODM_COMP_TX_PWR_TRACK,  ("Power Tracking TxRate=0x%X\n", TxRate));
